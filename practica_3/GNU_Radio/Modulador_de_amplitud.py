...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/com1_E1A_G4/labcom/GNURADIO_LABCOMUIS_2025_1_E1A_G4/practica_2/labachata_manuelturizo.wav', True)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.envolventecompleja_0, 0))
