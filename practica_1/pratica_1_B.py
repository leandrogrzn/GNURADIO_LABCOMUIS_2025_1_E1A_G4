...
class pratica_1_B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pratica_1_B")
        ...
        self._A_win = qtgui.RangeWidget(self._A_range, self.set_A, "Amplitud de la señal TX", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=pratica_1_B, options=None):
