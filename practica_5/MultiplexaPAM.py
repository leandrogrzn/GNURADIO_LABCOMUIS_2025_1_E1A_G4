...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_range = qtgui.Range(0, 10e3, 1, samp_rate/100, 200)
        ...
        self._fc_LPF_range = qtgui.Range(0, 10e3, 1, 50, 200)
        self._fc_LPF_win = qtgui.RangeWidget(self._fc_LPF_range, self.set_fc_LPF, "fracuencia corte", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_LPF_win)
        self._D5_range = qtgui.Range(0, 100, 1, 0, 200)
        self._D5_win = qtgui.RangeWidget(self._D5_range, self.set_D5, "Seleccion de señal RX", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D5_win)
        self._D4_range = qtgui.Range(0, 100, 1, 80, 200)
        self._D4_win = qtgui.RangeWidget(self._D4_range, self.set_D4, "Retardo 4", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D4_win)
        self._D3_range = qtgui.Range(0, 100, 1, 60, 200)
        ...
        self._D2_range = qtgui.Range(0, 100, 1, 40, 200)
        ...
        self._D1_range = qtgui.Range(0, 100, 1, 20, 200)
        ...
        self._D_range = qtgui.Range(0, 50, 1, 20, 200)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 3, 2, 6, 2)
        for r in range(3, 9):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/home/com1_E1A_G4/Descargas/despecha_rosalia.wav', True)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_float*1, D5)
        ...
        self.connect((self.ModulacionPAM_1, 0), (self.blocks_float_to_complex_0, 0))
        ...
        self.connect((self.blocks_delay_0_1_0, 0), (self.qtgui_time_sink_x_0, 4))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.fc_LPF, 1e3, window.WIN_HAMMING, 6.76))
    ...
    def set_D5(self, D5):
        self.D5 = D5
        self.blocks_delay_1.set_dly(int(self.D5))
