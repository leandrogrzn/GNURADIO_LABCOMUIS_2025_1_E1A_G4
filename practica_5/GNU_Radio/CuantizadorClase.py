...
class CuantizadorClase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "CuantizadorClase")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\maquina_leandro\\Downloads\\despecha_rosalia.wav', True)
